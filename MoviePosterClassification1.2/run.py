...
check = ModelCheckpoint("./Documents/exemuel/MoviePosterClassification1.2/weights.{epoch:02d}-{val_acc:.5f}.hdf5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=True, mode='auto')
